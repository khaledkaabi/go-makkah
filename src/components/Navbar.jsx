...
const Navbar = () => {
    ...
    const handleNavigateProfile = () => {
        setSelectedSection('inscription')
            ...
            <div className="px-10 pt-1 bg-white">
                <div className="flex justify-between items-center">
                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                        ...
                        >
                            <div className='px-2 py-2'>
                                <a onClick={()=> {
                                    handleNavigateHome()
                                    setSelectedSection('omra_c')
                                    }} href='#'>Omra combinée</a>
                            </div>
                        </div>
                        <div
                    ...
                    <div className="hidden lg:flex items-center space-x-4">
                        ...
                        <button className={`flex items-center space-x-2 px-2 pr-3 py-2 ${selectedSection === 'inscription' ? 'border-b-4 border-red-primary' : 'border-b-4 border-transparent'}`} onClick={handleNavigateProfile}>
          ...
          <div className="lg:hidden mt-4 pb-4">
            <div className="flex flex-col items-center space-y-2 mt-4">
              ...
              <div className="mt-4 pt-4 space-y-2">
                <button className="flex items-center space-x-2 px-3 py-2 w-full text-left">
                  <User className="w-4 h-4" />
                  <span>Mon compte</span>
                </button>
                <button onClick={handleNavigateProfile} className={`flex items-center space-x-2 px-3 py-2  rounded  w-full text-left ${selectedSection === 'inscription' ? 'border-b-4 border-red-primary' : 'border-b-4 border-transparent'}`}>
